                ...
                <div; className='basic-login'>
                    <form; name='form_login'; onSubmit={this.submitHandler}>
                        <div; className='form-group'>
                            <label; htmlFor='login-email'><i; className='icon-user'/> <b>E-Mail<sup; style={;{'red'}}>*</sup></;b></label>
                        ...
                        <div; className='form-group'>
                            <label; htmlFor='login-name'><i; className='icon-lock'/> <b>Имя<sup; style={;{'red'}}>*</sup></;b></label>
                            <input; className='form-control user-validation';
                                   id='login-name';
                                   name='name';
                                   type='text';
                        ...
                        <div; className='form-group'>
                            <label; htmlFor='login-lastName'><i; className='icon-lock'/> <b>Фамилия<sup; style={;{'red'}}>*</sup></;b></label>
                        ...
                        <div; className='form-group'>
                            <label; htmlFor='login-password1'><i; className='icon-lock'/> <b>Пароль<sup; style={;{'red'}}>*</sup></;b></label>
                            <input; className='form-control';
                                   id='login-password1';
                                   name='password1';
                                   type='password';
                        ...
                        <div; className='form-group'>
                            <label; htmlFor='login-password2'><i; className='icon-lock'/> <b>Повторите; пароль<sup; style={;{'red'}}>*</sup></;b></label>
                            <input; className='form-control user-validation';
                                   id='login-password2';
                                   name='password2';
                                   type='password';
